...
- mightyETL original source and documentation are now explicitly licensed under Apache-2.0 on the canonical documentation branch; third-party dependencies, container bases, bundled tools/assets, standards, and generated artifacts retain their own terms, and complete provenance/attribution plus distributable-license enforcement remains tracked separately.
