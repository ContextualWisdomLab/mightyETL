...
- The local dependency review workflow now skips pull requests targeting the default branch, where the central Security Scan provides the stricter dependency-review check, while retaining coverage for pull requests targeting other base branches.
