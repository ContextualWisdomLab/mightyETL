...
- ETL request errors now use RFC 9457 `application/problem+json` responses with a stable `errorCode`, fixed type URI, explicit 400/401/409/413/422/503/500 taxonomy, and no internal exception text in client responses.
