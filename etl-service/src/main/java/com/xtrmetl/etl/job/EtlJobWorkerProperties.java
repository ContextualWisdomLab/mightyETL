 ...
 *
 * <p>The worker is disabled unless an operator explicitly enables it. A process-lifetime lease
 ...
 * must never become a free-form log or database injection surface.</p>
 */
